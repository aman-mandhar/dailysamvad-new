...
return [
    ...
    'site_logo' => env('SEO_SITE_LOGO', '/images/frontend/logo.png'),
    ...
    'site_description' => env('SEO_SITE_DESCRIPTION', 'Read the latest breaking, featured and regional news from Rzana Punjab in Hindi, Punjabi and English.'),
    'publisher_type' => env('SEO_PUBLISHER_TYPE', 'NewsMediaOrganization'),
    'publisher_logo' => env('SEO_PUBLISHER_LOGO', env('SEO_SITE_LOGO', '/images/frontend/logo.png')),
    ...
    'news' => [
        'publication_name' => env('SEO_NEWS_PUBLICATION_NAME', env('WEBSITE_NAME', env('APP_NAME', 'Rzana Punjab'))),
